<%@ Page Title="" Language="C#" MasterPageFile="~/pTop.Master" AutoEventWireup="true" CodeBehind="DailyDeliveryReport.aspx.cs" Inherits="WarehouseApplication.DailyDeliveryReport" %>
                                    ...
                                    <table>
                                        <tr>
                                            <td style="background-color: #88AB2D" colspan="4">
                                                <asp:Label ID="lblSearchArrival" runat="server" Text="Search Daily delivery" ForeColor="White"
