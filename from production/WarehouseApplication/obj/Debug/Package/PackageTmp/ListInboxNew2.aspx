<%@ Page Title="" Language="C#" MasterPageFile="~/pTop.Master" AutoEventWireup="true" CodeBehind="ListInboxNew2.aspx.cs" Inherits="WarehouseApplication.ListInboxNew2" %>
                    ...
                    <asp:Panel ID="pnlDetail" Visible="false" runat="server">
                        ...
                        <div style="margin-top: 10px;">
                            <asp:GridView ID="grvDetail" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                PageSize="40" OnRowCommand="grvDetail_RowCommand"
                                Width="75%">
                                <FooterStyle BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                <RowStyle BackColor="#DAE1CC" />
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Task No.">
                                        <ItemTemplate>
                                            ...
                                            <asp:Label ID="lblTrackingNo" Width="200px" Visible="false" runat="server" Text='<%# Bind("TaskNo") %>'></asp:Label>
                                             <asp:Label ID="lblWorkflowID" Width="200px" Visible="false" runat="server" Text='<%# Bind("WorkflowID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
