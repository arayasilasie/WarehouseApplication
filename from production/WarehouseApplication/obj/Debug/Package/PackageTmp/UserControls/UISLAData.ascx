<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UISLAData.ascx.cs" Inherits="WarehouseApplication.UserControls.UISLAData" %>
...
<tr class="PreviewEditorCaption">
    <td colspan="2" style="width:475px" >SLA Data Report:</td>
</tr>
<tr>
<td>Warehouse name : 
...
<td class="Text" >Date Deposited :
     ...
     <td colspan="4" align="left">
         <asp:Button ID="btnSearch" runat="server" 
             Text="Genrate Report" Width="116px" onclick="btnSearch_Click" 
