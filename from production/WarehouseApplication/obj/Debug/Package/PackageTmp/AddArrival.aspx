...
<%--PROCESSING CENTER--%>       
          <div class="controlContainer">    
            <div class="leftControl">   
                <asp:Label ID="Label14" runat="server" Text="Processing Center/PM" ></asp:Label>
            </div>        
            <div class="rightControl">
                <%--<asp:DropDownList ID="ddlProcessingCenter" runat="server" Width="172px" ></asp:DropDownList>--%>  
                <asp:TextBox ID="txtProcessingCenter" runat="server" Width="168px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ForeColor="Tomato" 
                ControlToValidate="txtProcessingCenter" ErrorMessage="*" Display="Dynamic" ValidationGroup="Save" InitialValue=""></asp:RequiredFieldValidator>  
            </div>        
          </div> 
