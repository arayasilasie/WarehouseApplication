<%@ Page Title="" Language="C#" MasterPageFile="~/pTop.Master" AutoEventWireup="true"
    CodeBehind="GRNApproval.aspx.cs" Inherits="WarehouseApplication.GRNApproval" %>
        ...
        <ContentTemplate>
            <div class="container">
                ...
                <div id="Header" class="formHeader" style="width: 87%; margin-left: 40px; margin-top: 5px;"
                    align="center">
                    <asp:Label ID="lblDetail" Text="Data assistant GRN Approval" Width="100%" runat="server"></asp:Label>
                </div>
                ...
                <div style="clear: both; width: 87%; margin-left: 40px;">
                    <asp:GridView ID="grvGRNApproval" runat="server" AutoGenerateColumns="False" BackColor="White"
                        ...
                        OnRowDataBound="grvGRNApproval_RowDataBound" AllowPaging="True" 
                        PageSize="30" >
                        <EmptyDataTemplate>
