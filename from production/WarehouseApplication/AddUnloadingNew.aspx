...
<asp:Label ID="lblmsg" runat="server"></asp:Label></div>--%>    
    <asp:GridView ID="grdDisplayInfo" runat="server" 
    ...
    <%--SHADE--%>             
      ...
      <%--INVENTORY CONTROLLER--%>             
          <div class="controlContainer">    
            ...
            <div class="rightControl">
                <asp:DropDownList ID="cboInventoryController" runat="server" Width="174px" AppendDataBoundItems="true" Enabled="false">
...
//            lblNetWeight.innerHTML = (Math.round(decimalNetWeight * Math.pow(10, 2)) / Math.pow(10, 2));
    ...
    <asp:Label ID="LblHalfBagWeight" runat="server" Visible="False"></asp:Label>
<script type="text/javascript">
    CalculateNetWeight();
</script>   
    <asp:Label ID="LblNetWeightWithHalfBagWeight" runat="server" Visible="False"></asp:Label>
</div>
    </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
