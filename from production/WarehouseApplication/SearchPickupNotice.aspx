<%--<%@ Page Title="Search Pickup Notice" Language="C#" MasterPageFile="~/GINMaster.Master"
    AutoEventWireup="true" CodeBehind="SearchPickupNotice.aspx.cs" Inherits="GINPresentation.SearchPickupNotice" %>--%>

<%@ Page Language="C#" MasterPageFile="~/pTop.Master" AutoEventWireup="true" CodeBehind="SearchPickupNotice.aspx.cs"
    Inherits="WarehouseApplication.SearchPickupNotice" Title="Search Pickup Notice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceApp" runat="server">
    <script type="text/javascript">
        document.forms[0].elements['<%= btnGINProcess.ClientID %>'].style.visibility = "hidden";
        document.forms[0].elements['<%= btnPrintPUN.ClientID %>'].style.visibility = "hidden";
        document.forms[0].elements['<%= btnProcessPSA.ClientID %>'].style.visibility = "hidden";
        function ClientCheck() {
            ...
            if (flag == true) {
                ...
                document.forms[0].elements['<%= btnGINProcess.ClientID %>'].style.visibility = "visible";
                document.forms[0].elements['<%= btnProcessPSA.ClientID %>'].style.visibility = "visible";
                return true
            }
            else {
                document.forms[0].elements['<%= btnGINProcess.ClientID %>'].style.visibility = "hidden";
                                ...
                                <td>
                                    <table>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnGINProcess" runat="server" OnClick="btnGINProcess_Click" Text="Process GIN"
                                                    BackColor="#88AB2D" ForeColor="White" Width="80px" BorderStyle="None" 
                                                    CssClass="style1" />
                                            </td>
                                            <td>
                                                <asp:Button ID="btnProcessPSA" runat="server" Text="Process PSA" BackColor="#88AB2D"
                                                    ForeColor="White" Width="80px" BorderStyle="None" CssClass="style1" 
                                                    onclick="btnProcessPSA_Click" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="8">
                                ...
                                <td>
                                    <asp:Panel ID="pnlGrid" ScrollBars="Vertical" Height="800px" runat="server">
                                        <asp:GridView ID="gvSearchPickupNotice" runat="server" AutoGenerateColumns="False"
                                            ...
                                            BorderStyle="None" BorderWidth="1px" DataKeyNames="Id,CommodityGradeID,ProductionYear,WeightInKg,MaxLimit"
                                            OnRowDataBound="gvSearchPickupNotice_RowDataBound" CssClass="label" OnSelectedIndexChanged="gvSearchPickupNotice_SelectedIndexChanged"
                                            ...
                                            <Columns>
                                               ...
                                               <asp:BoundField DataField="Measurement" HeaderText="Unit" ItemStyle-Width="40px" />
                                            </Columns>
