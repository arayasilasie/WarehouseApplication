...
namespace GINBussiness
{
    ...
    public class GINModel : WarehouseBaseModel
    {
        ...
        public static DataTable PrintGINApprovalReport(Guid warehouseId, Guid selectedLIC)
        {
            return SQLHelper.getDataTable(ConnectionString, "GetAllUnapprovedGINReport", warehouseId, selectedLIC);
        }
