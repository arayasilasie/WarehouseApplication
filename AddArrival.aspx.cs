    ...
    public partial class AddArrivalNew : BasePage
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                for (int i = 0; i < LstBxCert.Items.Count; i++)
                    if (LstBxCert.Items[i].Selected == true)
                        theArrival.saveArrivalCertificate(theArrival.ID, new Guid(LstBxCert.Items[i].Value.ToString()), LstBxCert.Items[i].Text);
        ...
        private void PageToObject()
        {
            ...
            if (theArrival.IsLocationKnown)
            {
                ...
                try
                {
                    theArrival.WashingStation = new Guid(DDLwashingstation.SelectedValue);//txtProcessingCenter.Text;
                }
                catch
                {
                    theArrival.WashingStation = Guid.Empty;// null;
                }
                try
                {
                    theArrival.ProcessingCenter = "-"; //TxtBxProcCenter.Text;
                }
                catch
                {
                    theArrival.ProcessingCenter = null;
                }
            }
            else
            {
            ...
            try
            {
                theArrival.VehicleSize = Convert.ToDouble(DDlvehiclesize.SelectedValue.ToString());
            }
            catch
            {
                theArrival.VehicleSize = 0;
            }
        ...
        private void FillControls()
        {
            ...
            //BindCombo(DDLwashingstation, LookupTypeEnum.WashingStations, "");
            //DDLwashingstation.Items.Add(new ListItem("Please select . . .", ""));
        ...
        private void PopulateExistingData()
        {
            ...
            try
            {
                ...
                DDLwashingstation.SelectedValue = theArrival.WashingStation.ToString();
                //TxtBxProcCenter.Text = theArrival.ProcessingCenter;
        ...
        protected void cboRegion_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            string reIDstr = cboRegion.SelectedItem.ToString();
            DataTable dt = getwashingstation(reIDstr);
            populateWashingStation(dt);
        }
        ...
        protected void cboZone_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //DDLwashingstation.Enabled = true;
        }
        ...
        protected void cboCommodity_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cboCommodity.SelectedValue == "71604275-df23-4449-9dae-36501b14cc3b")
            {
                DDLwashingstation.Enabled = true;
                DDlvehiclesize.Enabled = true;
                LstBxCert.Enabled = true;
            }
            else
            {
                DDLwashingstation.Enabled = false;
                DDlvehiclesize.Enabled = false;
                LstBxCert.Enabled = false;
            }
        ...
        public void populateWashingStation(DataTable dt)
        {
           
            //DataTable dt;
            //dt = getwashingstation();
            DDLwashingstation.DataSource = dt;
            DDLwashingstation.DataTextField = "Description";
            DDLwashingstation.DataValueField = "ID";
            DDLwashingstation.Items.Add(new ListItem("Please Select . . .", ""));
            DDLwashingstation.DataBind(); 
        }
        ...
        protected void ChkBxclientcert_CheckedChanged(object sender, EventArgs e)
        {
            //if (ChkBxclientcert.Checked)
            //{
            //    LstBxCert.Enabled = true;
            //}
            //else if (ChkBxclientcert.Checked == false)
            //{
            //    LstBxCert.Enabled = false;
            //}
        }
