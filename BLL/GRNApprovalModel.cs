...
namespace WarehouseApplication.BLL
{
    public class GRNApprovalModel : WarehouseBaseModel
    {
        ...
        public static DataTable GetGRNForEditnApproval(Guid WarehouseID, int Status, string GRNNo)
        {
            return SQLHelper.getDataTable(ConnectionString, "GetGRNForEditnApproval", WarehouseID, Status, GRNNo);
        }
        ...
        public static DataTable GetAllLICs(Guid WarehouseID)
        {
            return SQLHelper.getDataTable(ConnectionString, "GetAllLICs", WarehouseID);
        }


        public static DataTable GetWHShedsbyLIC(Guid WarehouseID, Guid LIC)
        {
            return SQLHelper.getDataTable(ConnectionString, "GetWHShedsbyLIC", WarehouseID, LIC);
        }
        ...
        public static void EditGRNToWarehouse(string GRNNo, string Shed, Guid LICName2, string quad)
        {
            SQLHelper.execNonQuery(ConnectionString, "EditGRNToWarehouse", GRNNo, Shed, LICName2, UserBLL.CurrentUser.UserId, quad);
        }
    }      
}