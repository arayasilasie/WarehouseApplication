<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UIEditApprovedGRNEditRequest.ascx.cs" Inherits="WarehouseApplication.UserControls.UIEditApprovedGRNEditRequest" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="cc1" %>
<table class="PreviewEditor" style="width:900px"  >
<tr class="PreviewEditorCaption">
<td colspan="2" style="width:475px" >Approved GRN Edit Request<asp:HiddenField ID="hfGRNID" runat="server" />
...
<tr>
    ...
    <td  class="Input" >
        <asp:TextBox ID="txtDateRequested" runat="server" Height="22px" Width="128px"></asp:TextBox>
