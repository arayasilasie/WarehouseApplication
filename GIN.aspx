...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <%--<script src="Scripts/jQuery-v1.10.2.js" type="text/javascript"></script>--%>
        ...
        <ContentTemplate>
            ...
            <table bgcolor="White">
                <tr>
                    <td>
                        <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                            <ProgressTemplate>
                                <asp:Image ID="imgPleaseWait" ImageUrl="~/Images/pleasewait.gif" AlternateText="Please wait..."
                                    runat="server" />
                            </ProgressTemplate>
                        </asp:UpdateProgress>
                        <table>
                        ...
                        <table class="style4">
                                ...
                                <td colspan="13">
                                    <asp:GridView ID="gvPUNInformation" runat="server" AutoGenerateColumns="False" BackColor="White"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Measurement" HeaderText="Unit" ReadOnly="True" SortExpression="Measurement">
                                                <HeaderStyle HorizontalAlign="Left" />
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:BoundField>
                                        </Columns>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtIssuedBy" runat="server" ValidationGroup="date"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtTruckPlateNo" runat="server"></asp:TextBox>
                                </td>
                    </td>
                    <td>
                        <asp:TextBox ID="txtTrailerPlateNo" runat="server"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="13" style="background-color: #88AB2D">
                    ...
                    <td>
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtAvailableTimeOnly" Width="50px" runat="server"></asp:TextBox>
                                    ...
                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
                                            ControlToValidate="txtAvailableTimeOnly" ErrorMessage="Time is Required" 
                                            ValidationGroup="gin">*</asp:RequiredFieldValidator>
                                    ...
                                    <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
                                            ControlToValidate="txtAvailableTime" 
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
                                            ControlToValidate="txtDateLoaded" ErrorMessage="Date loaded is required field" 
                                            ValidationGroup="gin">*</asp:RequiredFieldValidator>
                                        <ajaxToolkit:ValidatorCalloutExtender ID="RequiredFieldValidator7_ValidatorCalloutExtender" 
                                            runat="server" Enabled="True" TargetControlID="RequiredFieldValidator7">
                                        </ajaxToolkit:ValidatorCalloutExtender>
                                        <ajaxToolkit:MaskedEditValidator ID="MaskedEditValidator2" runat="server" 
                                            ControlExtender="EarliestTimeExtender1" ControlToValidate="txtDateLoadedTime" 
                                            Display="None" InvalidValueMessage="Please enter a valid time." 
                                            SetFocusOnError="True">*</ajaxToolkit:MaskedEditValidator>
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" 
                                            ControlToValidate="txtDateLoadedTime" ErrorMessage="Time Is required" 
                                            ValidationGroup="gin">*</asp:RequiredFieldValidator>
                ...
                <tr>
                    <td>
                        ...
                        <%-- <asp:RegularExpressionValidator ID="RegularExpressionValidator9" runat="server" ControlToValidate="txtDateWeighted"
                                    ...
                                    ValidationGroup="gin">*</asp:RegularExpressionValidator>--%>
                        <%--  <ajaxToolkit:ValidatorCalloutExtender ID="RegularExpressionValidator9_ValidatorCalloutExtender"
                    ...
                    <td colspan="1">
                        <asp:DropDownList ID="drpTruckType" runat="server" Width="145px" CssClass="style1"
                            OnSelectedIndexChanged="drpTruckType_SelectedIndexChanged">
                    ...
                    <td colspan="1">
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            ...
                            <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="drpInventoryCoordinatorLoad" EventName="SelectedIndexChanged" />
                            </Triggers>
                        </asp:UpdatePanel>
                    </td>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td colspan="1">
                        &nbsp;
                        <asp:Label ID="lblScaleTicketNo" runat="server" CssClass="label" Text="Scale Ticket No.  :"></asp:Label>
                    </td>
                    <td colspan="1">
                        <asp:Label ID="lblTruckWeight" runat="server" Text="Truck Weight  :" CssClass="label"></asp:Label>
                    </td>
                    <td colspan="1">
                        <asp:Label ID="lblGrossWeight" runat="server" CssClass="label" Text="Gross Weight  :"></asp:Label>
                    </td>
                    <td colspan="1">
                        <asp:Label ID="lblLoadingTicket" runat="server" CssClass="label" Text="Loading Ticket NO:"></asp:Label>
                    </td>
                    <td colspan="2">
                        <asp:Label ID="Label1" runat="server" Text="Quadrant" CssClass="label"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="txtGrossWeight" runat="server" onkeyup="Calculate();" CssClass="style1"
                            OnTextChanged="txtGrossWeight_TextChanged"></asp:TextBox>
                    ...
                    <td colspan="2">
                        <asp:TextBox ID="txtQuadrant" runat="server" CssClass="style1" ValidationGroup="date"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td colspan="13">
                        <asp:GridView ID="gvStack" runat="server" BackColor="White" BorderColor="#CCCCCC"
                            ...
                            CssClass="label" Width="100%" DataKeyNames="Id,StackID" OnSelectedIndexChanged="gvStack_SelectedIndexChanged"
                ...
                <tr>
                    <td colspan="14" style="background-color: #88AB2D">
